...
from ASR.model.layers import DeepSpeech2Extractor, BNReluRNN, Linear
...
class DeepSpeech2(nn.Module):
    ...
    def __init__(
        ...
        #print('rnn_output_size', rnn_output_size)
        self.conv = DeepSpeech2Extractor(activation, mask_conv=True).to(self.device)
    ...
    def greedy_search(self, inputs, input_lengths):
        with torch.no_grad():
